...
@Autonomous(name="V3 Blue Far", group="main")
public class V3RobotBlueFarPreload extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        class SetTurret implements Action {
            @Override
            public boolean run(@NonNull TelemetryPacket packet) {
                packet.put("Turret Position", 65);
                robot.turret.setSmartTargetPosition(65);
                return false;
            }
        }
        ...
        Pose2d initialPose = new Pose2d(76.8, -4, Math.toRadians(-90));
        ...
        TrajectoryActionBuilder shootPreload = drive.actionBuilder(initialPose)
                ...
                .strafeToLinearHeading(new Vector2d(59.4, -1.9), Math.toRadians(-90))
                ...
                .strafeToLinearHeading(new Vector2d(76.8, -4), Math.toRadians(-90))
                .strafeToLinearHeading(new Vector2d(76.8, -51), Math.toRadians(-90))
                ...
                .strafeToLinearHeading(new Vector2d(51, -9), Math.toRadians(-90))
