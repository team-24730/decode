...
public class V2RobotBlueClose extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder shootPreload = drive.actionBuilder(initialPose)
                ...
                .strafeToLinearHeading(new Vector2d(-20, -4), Math.toRadians(-135)) // shoot preload
                .waitSeconds(2.0) // see if time can be saved

                /* First Spike */
                .afterTime(0.1, new IntakeOn())
                .splineTo(new Vector2d(-14, -40), Math.toRadians(-90), new VelConstraint() {
                    @Override
                ...
                /* Second Spike */
                .strafeToLinearHeading(new Vector2d(13, -6), Math.toRadians(-90))
                .afterTime(0.0, new IntakeOn())
                .strafeToLinearHeading(new Vector2d(13, -50), Math.toRadians(-90), new VelConstraint() {
                    @Override
                    public double maxRobotVel(@NonNull Pose2dDual<Arclength> pose2dDual, @NonNull PosePath posePath, double v) {
                        return 40;
                    }
                ...
                .strafeToLinearHeading(new Vector2d(2, -30), Math.toRadians(-0)) // open gate
                .waitSeconds(0.5)
                ...
                .strafeToLinearHeading(new Vector2d(38, -50), Math.toRadians(-90), new VelConstraint() {
                    @Override
                    public double maxRobotVel(@NonNull Pose2dDual<Arclength> pose2dDual, @NonNull PosePath posePath, double v) {
                        return 30;
                    }
